...
この章では、三つの時代を区別します。DNS以前にも、ホスト名とアドレスの対応を調べる仕組みはありました。1983年に提案され、1987年に現在の骨格が定まったDNSは、その対応情報を大規模に管理し、参照する方法を変えました。その後、同じ仕組みの上で、負荷分散や障害時の切り替えなど、後から普及した用途もあります。
