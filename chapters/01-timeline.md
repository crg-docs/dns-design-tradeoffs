...
**集中管理が始まる（1973〜1985年）**――公式のホスト名一覧は存在しましたが、機械可読の形でネットワーク越しに取得できませんでした。各サイトが自前の表を手で維持し、どれも不完全で、互いに食い違っていました。1974年にNICが機械可読の一覧を定期生成する体制を引き受け、1982年に仕様として定まります。集中管理は、より悪い分散状態への対処として始まりました。この時点で未解決だったのは、名前を使う前に中央と交渉して登録しなければならないことと、一意性の調整を中央が担っていたことです。
...
| 時代 | 詳しく扱う章 |
| --- | --- |
| 集中管理が始まる | [第2章 拡張性](02-scalability.md) |
| 分散への転換 | [第2章 拡張性](02-scalability.md) |
| 隙間を埋める | 第5章 整合性と変更反映 |
| 拡張の余地を作る | 第9章 後方互換性と発展性 |
| 応答を信用する | 第6章 セキュリティ |
| 悪用への耐性 | 第6章 セキュリティ、第4章 可用性と障害耐性 |
| 見られていることへの対処 | 第7章 プライバシー |
| 壊れても答え続ける | 第4章 可用性と障害耐性、第5章 整合性と変更反映 |

## この章の言い換え

冒頭に挙げたものに加えて、次の2つが言えるようになります。
